...
# Must figure out the two helper functions !!!!




# define some additional helper layers to help with functions in layers.py. 
# refer to: https://github.com/mantasu/cs231n/blob/master/assignment2/cs231n/layer_utils.py
