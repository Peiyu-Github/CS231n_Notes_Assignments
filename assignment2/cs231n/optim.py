...
def sgd_momentum(w, dw, config=None):
    ...
    # # refer to Notes Dec 21-22, 2022
    # # https://github.com/mantasu/cs231n/blob/master/assignment2/cs231n/optim.py
    # keys = ['learning_rate','momentum', 'velocity'] # keys in this order
    # learning_rate, mu, v = (config.get(k) for k in keys) # vals in this order

    # config['velocity'] = v = mu * v - learning_rate * dw # integrate velocity
    # next_w = w + v # integrate position


    # https://github.com/samlkrystof/Stanford-CS231n/blob/main/assignment2/cs231n/optim.py
...
def rmsprop(w, dw, config=None):
    ...
    learning_rate, decay_rate, eps, cache = (config.get(key) for key in keys)

    config['cache'] = cache = decay_rate * cache + (1 - decay_rate) * dw**2
